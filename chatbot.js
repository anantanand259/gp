...
const CHATBOT_CONFIG = {
    ...
    OPENROUTER_MODEL: 'qwen/qwen2.5-14b-instruct:free',
...
class ChatbotUI {
    ...
    // ─── OpenRouter API Call (Qwen 2.5 14B — OpenAI-compatible) ───
    async _callOpenRouter(prompt, history) {
        const apiKey = CHATBOT_CONFIG.OPENROUTER_API_KEY;
            ...
            try {
                const response = await fetch(OPENROUTER_BASE, {
                    ...
                    headers: {
                        ...
                        'HTTP-Referer': window.location.origin || 'https://gpa.ac.in',
